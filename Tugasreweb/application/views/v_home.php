  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       <img src="assets/images/baubau.png" class="logo-icon" alt="logo icon"><br>
       <h5 class="logo-text">BAPPEDA</h5>
     </a>
   </div>
   ...
   <ul class="sidebar-menu do-nicescrol">
    <br><br><br><br>
       ...
       <li>
        <a href="v_home.php" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>HOME</span>
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>BERITA</span>
          
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>GALERI</span>
          
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>DOKUMEN</span>
          
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>PUBLIKASI</span>
          
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>SOSIAL</span>
          <small class="badge float-right badge-danger">10</small>
        </a>
      </li>
      <li>
        <a href="widgets.html" class="waves-effect">
          <i class="zmdi zmdi-widgets"></i> <span>PENGUMUMAN</span>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <div class="media-body">
            <h6 class="mt-2 user-title"><?php echo $this->session->userdata('nama')?></h6>
        ...
        <li class="dropdown-divider"></li>
        <a href="<?php echo site_url('login/logout')?>"><li class="dropdown-item"><i class="icon-power mr-2"></i>Logout</li></a>
      </ul>
    </li>
  </ul>
</nav>
  ...
  <div class="content-wrapper">
    <div class="container-fluid"><br>
     ...
     <div class="row pt-2 pb-2">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Pengumuman</a></li>
     ...
     <div class="col-sm-3"><br><br>
       <div class="btn-group float-sm-right">
        <button type="button" class="btn btn-outline-primary waves-effect waves-light" data-toggle="modal" data-target="#primarymodal"><i class="fa fa-plus"></i> Tambah data</button>
    ...
    <!-- End Breadcrumb-->
       <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
       <div class="card-header text-uppercase text-primary">Pengunguman</div>
            <div class="card-body">
                ...
                <table class="table">
                  <thead class="thead-primary">
                    <tr>
                      ...
                      <th scope="col">isi pengumuuman</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $no = 0;?>
                    <?php foreach ($data_pengunguman as $data):?>
                    <?php $no++;?>
                    <tr>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content border-primary">
                      <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white">Form Input Data</h5>
                      ...
                      <div class="modal-body">
                        <form method="post" action="<?php echo base_url().'Home/tambah_data'; ?>" >
                          <label for="input-1">Judul Pengunguman</label>
                          <input type="text" name="judul" class="form-control"><br>
                          <label for="input-1">Isi Pengunguman</label>
